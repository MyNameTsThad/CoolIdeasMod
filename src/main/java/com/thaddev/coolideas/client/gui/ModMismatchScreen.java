...
public class ModMismatchScreen extends Screen {
    ...
    public ModMismatchScreen(String clientModVersion, String serverModVersion, String clientModLoader, String serverModLoader) {
        super(new TranslatableText(CoolIdeasMod.SCREEN_VERSION_MISMATCH));
    ...
    protected void init() {
        ...
        this.addDrawableChild(drawCenteredButtonWidget((this.width / 2) - 160, pos + 25, 150, 20, false, new TranslatableText(OPEN_CURSEFORGE),
                (pButtonWidget) ->
        ...
        this.addDrawableChild(drawCenteredButtonWidget((this.width / 2), pos + 25, 150, 20, false, new TranslatableText(OPEN_MODRINTH),
                (pButtonWidget) ->
                    this.client.setScreen(new ConfirmChatLinkScreen((confirmed) -> {
                        if (confirmed) {
                            Util.getOperatingSystem().open("");
